...
let ViewModel = function() {
    ...
    self.deploy = function() {
        ...
        for(let i = 0; i < model.markers().length; i++) {
            ...
            model.markers()[i].addListener('click', (function(iCopy) {//add an info window to each element
                infoWindow.open(self.map, model.markers()[iCopy]);//problem: Uncaught TypeError: Cannot read property 'apply' of undefined whenever I want a infoWindow reopened
            })(i));
